...
import uz.result.rmcdeluxe.entity.investment.*;
...
import uz.result.rmcdeluxe.payload.investment.FrequentlyAskedQuestionDTO;
import uz.result.rmcdeluxe.payload.investment.PurchaseProcessDTO;
import uz.result.rmcdeluxe.repository.investment.FrequentlyAskedQuestionRepository;
import uz.result.rmcdeluxe.repository.investment.QuestionRepository;
