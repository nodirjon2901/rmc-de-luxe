...
import uz.result.rmcdeluxe.payload.temporary.investment.PurchaseProcessDTO;
import uz.result.rmcdeluxe.repository.temporary.investment.PurchaseProcessRepository;
import uz.result.rmcdeluxe.repository.temporary.investment.PurchaseProcessStepRepository;
...
public class PurchaseProcessService {
    ...
    public ResponseEntity<ApiResponse<PurchaseProcess>> addStep(String step) {
        ...
        if (!processOptional.isPresent()) {
            PurchaseProcessStep purchaseProcessStep = null;
            ...
            try {
                ...
                purchaseProcessStep = objectMapper.readValue(step, PurchaseProcessStep.class);
                PurchaseProcessStep save1 = stepRepository.save(purchaseProcessStep);
                save.setSteps(List.of(save1));
                PurchaseProcess save2 = processRepository.save(save);
                response.setData(save2);
